...
public class Mineralistic {
	...
	public static final String CLIENT_PROXY = "rong.mineralistic.proxies.ClientProxy";
	public static final String COMMON_PROXY = "rong.mineralistic.proxies.CommonProxy";
